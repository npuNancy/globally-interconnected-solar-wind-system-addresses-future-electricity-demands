%% Optimization_SA_2030.m — 2030年 SSP2-4.5 成本最小化优化（邻近互联 S-A）
%
...
load(fullfile(RESULTS_DIR, 'Opt_SC_2040_Sel.mat'), 'opt_trans', 'opt_stoCap', 'opt_stoPow', 'opt_wind', 'opt_solar');
...
[c_init, ceq_init] = nonlcon2030(greedy_sol, cost_cfg, scenario_cfg, model_data, persistent_data);
...
%% ======================== 9.5 最终解可行性检查 ========================
[c_best, ceq_best] = nonlcon2030(best_scale, cost_cfg, scenario_cfg, model_data, persistent_data);
...
if ~feasibility.is_feasible
    ...
    fail_file = fullfile(failed_dir, sprintf('Optimization_SA_2030_failed_%s.mat', timestamp));
...
matfile = fullfile(RESULTS_DIR, 'Optimization_SA_2030_metrics.mat');
save(matfile, ...
