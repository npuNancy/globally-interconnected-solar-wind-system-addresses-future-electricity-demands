...
# Pareto 前沿绘图：2050
if ! plot_pareto "SSP2-4.5" 2050 "results/Optimization_SC_2050_Res.h5" "results/Opt_SC_2050_Sel.mat" "results/img/pareto_front_2050.png"; then
    exit 1
fi
...
# Pareto 前沿绘图：2040
if ! plot_pareto "SSP2-4.5" 2040 "results/Optimization_SC_2040_Res.h5" "results/Opt_SC_2040_Sel.mat" "results/img/pareto_front_2040.png"; then
    exit 1
fi
...
# Pareto 前沿绘图：2030
if ! plot_pareto "SSP2-4.5" 2030 "results/Optimization_SA_2030_Res.h5" "results/Opt_SA_2030_Sel.mat" "results/img/pareto_front_2030.png"; then
    exit 1
fi
