function [c, ceq, constraint_names] = nonlcon2030(x, cost_cfg, scenario_cfg, model_data, persistent_data)
% nonlcon2030 — 2030年成本最小化非线性约束（SSP5-6.0）
%
% 约束逻辑：
...
%
% 用法：
%   nonlcon2030(x)                          — 由 ga 调用，从持久变量加载配置
%   nonlcon2030(x, cost_cfg, scenario_cfg, model_data, persistent_data)
%                                           — 直接传参（用于测试）
%
% 注意：单参数模式需要先运行 Optimization_SA_2030.m 保存模型数据
%       至 results/model_data_2030.mat。
